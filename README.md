# httpenv
Tiny HTTP server showing the environment variables on TCP 7777.
...
Run it from Docker Hub on host port 7777:

`docker run -d -p 7777:7777 bretfisher/httpenv`

or from GitHub Container Registry (GHCR) with:

`docker run -d -p 7777:7777 ghcr.io/bretfisher/httpenv`
