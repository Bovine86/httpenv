# httpenv-modified
Tiny HTTP server showing the environment variables on TCP 9999.
...
Run it from Docker Hub on host port 9999:

`docker run -d -p 9999:9999 bretfisher/httpenv`

or from GitHub Container Registry (GHCR) with:

`docker run -d -p 9999:9999 ghcr.io/bretfisher/httpenv`
